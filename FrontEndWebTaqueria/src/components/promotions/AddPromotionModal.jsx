          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-xs text-inkalt file:mr-3 file:py-2 file:px-3 file:rounded-none file:border-0 file:bg-surfalt file:text-inkalt file:text-xs file:font-semibold"
              />
            </div>
          </div>
        </form>
